 ...
 * on 2015-12-12 at 02:51:34 UTC 
 * Modify at your own risk.
 */

package net.catsonmars.android.app.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://javajokesserver.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<net.catsonmars.android.app.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, net.catsonmars.android.app.backend.myApi.model.MyBean.class);
  ...
  public class TellJoke extends MyApiRequest<net.catsonmars.android.app.backend.myApi.model.MyBean> {
